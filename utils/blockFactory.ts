export const createBlock = (type: string, variant: string, label: string) => {
  ...
  // --- KONTENERY I ALERTY I MENU ---
  if (type === 'container') {
    if (variant === 'nav-classic') {
      newBlock.name = 'NAVBAR'; newBlock.styles.display = 'flex'; newBlock.styles.flexDirection = 'row'; newBlock.styles.alignItems = 'center'; newBlock.styles.justifyContent = 'space-between'; newBlock.styles.padding = '20px 40px'; newBlock.styles.backgroundColor = '#ffffff'; newBlock.styles.borderBottom = '1px solid #e2e8f0'; newBlock.styles.width = '100%';
      const logo = createBlock('h2', 'brand', 'Logo'); logo.text = 'LOGO'; logo.styles.fontSize = '24px'; logo.styles.margin = '0'; logo.styles.color = '#0f172a'; logo.styles.borderBottom = 'none';
      const links = createBlock('container', 'empty', 'Linki'); links.styles.display = 'flex'; links.styles.flexDirection = 'row'; links.styles.gap = '30px'; links.styles.backgroundColor = 'transparent'; links.styles.padding = '0'; links.styles.minHeight = 'auto'; links.styles.width = 'auto'; links.styles.border = 'none';
      const l1 = createBlock('p', 'classic', 'Link'); l1.text = 'O nas'; l1.styles.margin = '0'; l1.styles.fontWeight = '600'; l1.styles.cursor = 'pointer';
      const l2 = createBlock('p', 'classic', 'Link'); l2.text = 'Usługi'; l2.styles.margin = '0'; l2.styles.fontWeight = '600'; l2.styles.cursor = 'pointer';
      const l3 = createBlock('p', 'classic', 'Link'); l3.text = 'Kontakt'; l3.styles.margin = '0'; l3.styles.fontWeight = '600'; l3.styles.cursor = 'pointer';
      links.children = [l1, l2, l3];
      const btn = createBlock('button', 'classic', 'Akcja'); btn.text = 'Rozpocznij';
      newBlock.children = [logo, links, btn];
    }
    else if (variant === 'nav-pill') {
      newBlock.name = 'FLOATING NAV'; newBlock.styles.display = 'flex'; newBlock.styles.flexDirection = 'row'; newBlock.styles.alignItems = 'center'; newBlock.styles.justifyContent = 'space-between'; newBlock.styles.padding = '10px 20px'; newBlock.styles.backgroundColor = 'rgba(255, 255, 255, 0.8)'; newBlock.styles.backdropFilter = 'blur(12px)'; newBlock.styles.borderRadius = '999px'; newBlock.styles.boxShadow = '0 10px 25px -5px rgba(0,0,0,0.1)'; newBlock.styles.width = '90%'; newBlock.styles.margin = '20px auto'; newBlock.styles.border = '1px solid rgba(255, 255, 255, 0.3)';
      const logo = createBlock('h2', 'brand', 'Logo'); logo.text = 'LOGO'; logo.styles.fontSize = '20px'; logo.styles.margin = '0'; logo.styles.color = '#0f172a'; logo.styles.borderBottom = 'none';
      const links = createBlock('container', 'empty', 'Linki'); links.styles.display = 'flex'; links.styles.flexDirection = 'row'; links.styles.gap = '25px'; links.styles.backgroundColor = 'transparent'; links.styles.padding = '0'; links.styles.minHeight = 'auto'; links.styles.width = 'auto'; links.styles.border = 'none';
      const l1 = createBlock('p', 'classic', 'Link'); l1.text = 'Home'; l1.styles.margin = '0'; l1.styles.fontWeight = '600'; l1.styles.color = '#334155'; l1.styles.cursor = 'pointer';
      const l2 = createBlock('p', 'classic', 'Link'); l2.text = 'Cennik'; l2.styles.margin = '0'; l2.styles.fontWeight = '600'; l2.styles.color = '#334155'; l2.styles.cursor = 'pointer';
      links.children = [l1, l2];
      const btn = createBlock('button', 'rounded', 'Akcja'); btn.text = 'Zaloguj'; btn.styles.padding = '10px 24px';
      newBlock.children = [logo, links, btn];
    }
    else if (variant === 'footer-columns') {
      newBlock.name = 'FOOTER PRO'; newBlock.styles.display = 'grid'; newBlock.styles.gridTemplateColumns = '2fr 1fr 1fr 1fr'; newBlock.styles.gap = '40px'; newBlock.styles.padding = '60px 40px'; newBlock.styles.backgroundColor = '#0f172a'; newBlock.styles.width = '100%';
      const col1 = createBlock('container', 'empty', 'Kolumna'); col1.styles.border = 'none'; col1.styles.backgroundColor = 'transparent'; col1.styles.padding = '0'; col1.styles.gap = '15px';
      const logo = createBlock('h2', 'classic', 'Logo'); logo.text = 'FIRMA'; logo.styles.color = '#ffffff'; logo.styles.margin = '0';
      ...
      const col2 = createBlock('container', 'empty', 'Kolumna'); col2.styles.border = 'none'; col2.styles.backgroundColor = 'transparent'; col2.styles.padding = '0'; col2.styles.gap = '10px';
      const hProduct = createBlock('p', 'eyebrow', 'Nagłówek'); hProduct.text = 'PRODUKT'; hProduct.styles.color = '#ffffff'; hProduct.styles.margin = '0';
      ...
      const col3 = createBlock('container', 'empty', 'Kolumna'); col3.styles.border = 'none'; col3.styles.backgroundColor = 'transparent'; col3.styles.padding = '0'; col3.styles.gap = '10px';
      const hCompany = createBlock('p', 'eyebrow', 'Nagłówek'); hCompany.text = 'FIRMA'; hCompany.styles.color = '#ffffff'; hCompany.styles.margin = '0';
      ...
      const col4 = createBlock('container', 'empty', 'Kolumna'); col4.styles.border = 'none'; col4.styles.backgroundColor = 'transparent'; col4.styles.padding = '0'; col4.styles.gap = '10px';
      const hLegal = createBlock('p', 'eyebrow', 'Nagłówek'); hLegal.text = 'PRAWNE'; hLegal.styles.color = '#ffffff'; hLegal.styles.margin = '0';
      ...
      newBlock.children = [col1, col2, col3, col4];
    }
