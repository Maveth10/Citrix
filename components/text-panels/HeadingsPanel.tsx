    ...
    <div className="flex flex-col bg-black/10">
      ...
      <button onClick={() => handleAddBlock('h1', 'brand', 'Markowy Tytuł')} className={btnWrapper}>
        ...
        <div>
          ...
          <span className="text- text-neutral-500 block leading-tight font-light">Niebieski, mocny akcent.</span>
        </div>
      </button>
      ...
      <button onClick={() => handleAddBlock('h1', 'gradient', 'Gradient H1')} className={btnWrapper}>
        ...
        <div>
          ...
          <span className="text- text-neutral-500 block leading-tight font-light">Przejście z cyjanu w fiolet.</span>
        </div>
      </button>
      ...
      <button onClick={() => handleAddBlock('h1', 'outline', 'Outline H1')} className={btnWrapper}>
        ...
        <div>
          ...
          <span className="text- text-neutral-500 block leading-tight font-light">Stylowy obrys tekstu (Stroke).</span>
        </div>
      </button>
      ...
      <button onClick={() => handleAddBlock('h1', 'highlight', 'H1 Wyróżnik')} className={btnWrapper}>
        ...
        <div>
          ...
          <span className="text- text-neutral-500 block leading-tight font-light">Tło przypominające marker.</span>
        </div>
      </button>
      ...
      <button onClick={() => handleAddBlock('h2', 'brand', 'Markowy Nagłówek')} className={btnWrapper}>
        ...
        <div>
          ...
          <span className="text- text-neutral-500 block leading-tight font-light">Z dolną linią akcentującą.</span>
        </div>
      </button>
      ...
      <button onClick={() => handleAddBlock('h2', '', 'Zwykły Nagłówek')} className={btnWrapper}>
        ...
        <div>
          ...
          <span className="text- text-neutral-500 block leading-tight font-light">Klasyczny tekst wspomagający.</span>
        </div>
      </button>
